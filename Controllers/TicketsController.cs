...
namespace Eventchain.Controllers
{
    ...
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TicketId,Title,EventId")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TicketId,Title,EventId")] Ticket ticket)
        {
